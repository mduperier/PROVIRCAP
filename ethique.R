...
nombre_observations <- nrow(data_eth)
print(nombre_observations)
#il y a 63 observations au total
#(63 personnes qui ont déclaré traiter de cette thématique dans leur mission)
...
# Genre
create_bar_plot(data_eth, "Genre", "genre_eth.png")
create_percentage_bar_plot(data_eth, "Genre", "genre_eth_pourcentage.png")

# Variable d'âge
p<-ggplot(data_eth, aes(x = age, fill=age)) +
  geom_bar() +
  ...
  theme_minimal()
print(p)
ggsave(filename = "age_eth.png", plot = p, width = 8, height = 6)

# Âge mais version tranches
data_eth$age_group <- cut(data_eth$age, breaks = seq(0, max(data_eth$age, na.rm = TRUE), by = 5), right = FALSE)

p <- ggplot(data_eth, aes(x = age_group, fill = age_group)) +
  geom_bar() +
...
print(p)
ggsave(filename = "age_eth_tranches.png", plot = p, width = 8, height = 6)

#Situation matrimoniale
create_bar_plot(data_eth, "Situ_matri", "situ_matri_eth.png")
create_percentage_bar_plot(data_eth, "Situ_matri", "situ_matri_eth_pourcentage.png")

#Lieu de vie 
create_bar_plot(data_eth, "Lieu_vie", "lieu_eth.png")
create_percentage_bar_plot(data_eth, "Lieu_vie", "lieu_eth_pourcentage.png")
...
create_bar_plot(data_eth, "dipl_niv_short", "diplome_eth.png")
create_percentage_bar_plot(data_eth, "dipl_niv_short", "diplome_eth_pourcentage.png")


#Etablissement d'études sup
create_bar_plot(data_eth, "Type_etudsup", "etude_eth.png")
create_percentage_bar_plot(data_eth, "Type_etudsup", "etude_eth_pourcentage.png")
...
create_bar_plot(data_eth, "Spe_etudsup", "spe_eth.png")
create_percentage_bar_plot(data_eth, "Spe_etudsup", "spe_eth_pourcentage.png")
...
create_bar_plot(data_eth, "Emp_cont_short", "statut_eth.png")
create_percentage_bar_plot(data_eth, "Emp_cont_short", "statut_eth_pourcentage.png")

#Type de cadre
create_bar_plot(data_eth, "cadre_inout", "cadre_eth.png")
create_percentage_bar_plot(data_eth, "cadre_inout", "cadre_eth_pourcentage.png")



#Type d'emploi des consultant.es

df_filtered <- data_eth %>% 
  filter(Emp_cons == "Oui")
...
create_bar_plot(df_filtered, "emp_cont_grouped", "emploi_cons_eth.png")
create_percentage_bar_plot(df_filtered, "emp_cont_grouped", "emploi_cons_eth_pourcentage.png")



#Niveau hiérarchique
create_bar_plot(data_eth, "Emp_statut", "hiérarchie_eth.png")
create_percentage_bar_plot(data_eth, "Emp_statut", "hiérarchie_eth_pourcentage.png")

#Tableau descriptif de l'âge selon les différents postes
descriptives <- data_eth %>%
  group_by(Emp_statut) %>%
  summarise(
...
create_bar_plot(data_eth, "Emp_statut_rec2", "hiérarchie_s_eth.png")
create_percentage_bar_plot(data_eth, "Emp_statut_rec2", "hiérarchie_s_eth_pourcentage.png")


#Un escalator de verre?
gender_distribution <- data_eth %>%
...
print(p)
ggsave(filename = "répartition_hf_eth.png", plot = p, width = 8, height = 6)


#Type d'organisation employeuse
create_bar_plot(data_eth, "Org_type", "org_eth.png")
create_percentage_bar_plot(data_eth, "Org_type", "org_eth_pourcentage.png")

# Niveau hiérarchique hors consultant.es

filtered_data <- data_eth %>%
  filter(Emp_cons == "Non") 
create_bar_plot(filtered_data, "Emp_statut", "hiérarchie2_eth.png")
create_percentage_bar_plot(filtered_data, "Emp_statut", "hiérarchie2_eth_pourcentage.png")

#Niveau hiérarchique consultant.es
filtered_data <- data_eth %>%
  filter(Emp_cons == "Oui") 
create_bar_plot(filtered_data, "Emp_statut", "hiérarchie2_cons_eth.png")
create_percentage_bar_plot(filtered_data, "Emp_statut", "hiérarchie2_cons_eth_pourcentage.png")

#Année du premier CDD ou CDI de la carrière
p<-ggplot(data_eth, aes(x = Prem_contrat_annee)) +
  geom_bar() +
...
print(p)
ggsave(filename = "premier_emploi_eth.png", plot = p, width = 8, height = 6)

#version tranches

data_eth$age_group <- cut(data_eth$Prem_contrat_annee, breaks = seq(0, max(data_eth$Prem_contrat_annee, na.rm = TRUE), by = 5), right = FALSE)
...
print(p)
ggsave(filename = "prem_emploi_eth_tranches.png", plot = p, width = 8, height = 6)




#Année du premier poste en RSE
p<- ggplot(data_eth, aes(x = Prem_rse_annee_rec)) +
  geom_bar() +
...
print(p)
ggsave(filename = "premier_rse_eth.png", plot = p, width = 8, height = 6)

#Temps consacré à la rse
create_bar_plot(data_eth, "Rse_tps_rec", "temps_rse_eth.png")

#Emp sec
create_bar_plot(data_eth, "Emp_sec", "secteur_eth.png")

#Temps plein
create_bar_plot(data_eth, "Trav_tps", "temps_plein_eth.png")

#Multinationale
create_bar_plot(data_eth, "Org_multi", "multinationale_eth.png")

#Salariés français
create_bar_plot(data_eth, "Org_N", "salaries_fr_eth.png")

#Salariés international
create_bar_plot(data_eth, "Org_N_int", "salaries_int_eth.png")
...
print(p)
ggsave(filename = "activ_sec_eth.png", plot = p, width = 8, height = 6)

#Département RSE?
create_bar_plot(data_eth, "Dep_rse", "dep_rse_eth.png")
...
create_bar_plot(data_eth, "Dep_rse_multi", "dep_rse_niv_eth.png")

#Terme RSE
create_bar_plot(data_eth, "Rse_mot", "mot_rse_eth.png")

#Lois RSE
create_bar_plot(data_eth, "Rse_lois", "lois_eth.png")

#Vocation
create_bar_plot(data_eth, "Rse_vocation_rec", "vocation_eth.png")

#Critiques ONG
create_bar_plot(data_eth, "Rse_ong_milit_rec", "critiques_eth.png")

#Position politique 
create_bar_plot(data_eth, "Pol_pos_SQ001", "politique_eth.png")
