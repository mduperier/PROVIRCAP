...
nombre_observations <- nrow(data_div)
print(nombre_observations)
#il y a 79 observations au total
#(79 personnes qui ont déclaré traiter de cette thématique dans leur mission)
...
# Genre
create_bar_plot(data_div, "Genre", "genre_div.png")
create_percentage_bar_plot(data_div, "Genre", "genre_div_pourcentage.png")

# Variable d'âge
p<-ggplot(data_div, aes(x = age, fill=age)) +
  geom_bar() +
  ...
  theme_minimal()
print(p)
ggsave(filename = "age_div.png", plot = p, width = 8, height = 6)

# Âge mais version tranches
data_div$age_group <- cut(data_div$age, breaks = seq(0, max(data_div$age, na.rm = TRUE), by = 5), right = FALSE)

p <- ggplot(data_div, aes(x = age_group, fill = age_group)) +
  geom_bar() +
...
print(p)
ggsave(filename = "age_div_tranches.png", plot = p, width = 8, height = 6)

#Situation matrimoniale
create_bar_plot(data_div, "Situ_matri", "situ_matri_div.png")
create_percentage_bar_plot(data_div, "Situ_matri", "situ_matri_div_pourcentage.png")

#Lieu de vie 
create_bar_plot(data_div, "Lieu_vie", "lieu_div.png")
create_percentage_bar_plot(data_div, "Lieu_vie", "lieu_div_pourcentage.png")
...
create_bar_plot(data_div, "dipl_niv_short", "diplome_div.png")
create_percentage_bar_plot(data_div, "dipl_niv_short", "diplome_div_pourcentage.png")


#Etablissement d'études sup
create_bar_plot(data_div, "Type_etudsup", "etude_div.png")
create_percentage_bar_plot(data_div, "Type_etudsup", "etude_div_pourcentage.png")
...
create_bar_plot(data_div, "Spe_etudsup", "spe_div.png")
create_percentage_bar_plot(data_div, "Spe_etudsup", "spe_div_pourcentage.png")
...
create_bar_plot(data_div, "Emp_cont_short", "statut_div.png")
create_percentage_bar_plot(data_div, "Emp_cont_short", "statut_div_pourcentage.png")

#Type de cadre
create_bar_plot(data_div, "cadre_inout", "cadre_div.png")
create_percentage_bar_plot(data_div, "cadre_inout", "cadre_div_pourcentage.png")



#Type d'emploi des consultant.es

df_filtered <- data_div %>% 
  filter(Emp_cons == "Oui")
...
create_bar_plot(df_filtered, "emp_cont_grouped", "emploi_cons_div.png")
create_percentage_bar_plot(df_filtered, "emp_cont_grouped", "emploi_cons_div_pourcentage.png")



#Niveau hiérarchique
create_bar_plot(data_div, "Emp_statut", "hiérarchie_div.png")
create_percentage_bar_plot(data_div, "Emp_statut", "hiérarchie_div_pourcentage.png")

#Tableau descriptif de l'âge selon les différents postes
descriptives <- data_div %>%
  group_by(Emp_statut) %>%
  summarise(
...
create_bar_plot(data_div, "Emp_statut_rec2", "hiérarchie_s_div.png")
create_percentage_bar_plot(data_div, "Emp_statut_rec2", "hiérarchie_s_div_pourcentage.png")


#Un escalator de verre?
gender_distribution <- data_div %>%
...
print(p)
ggsave(filename = "répartition_hf_div.png", plot = p, width = 8, height = 6)


#Type d'organisation employeuse
create_bar_plot(data_div, "Org_type", "org_div.png")
create_percentage_bar_plot(data_div, "Org_type", "org_div_pourcentage.png")

# Niveau hiérarchique hors consultant.es

filtered_data <- data_div %>%
  filter(Emp_cons == "Non") 
create_bar_plot(filtered_data, "Emp_statut", "hiérarchie2_div.png")
create_percentage_bar_plot(filtered_data, "Emp_statut", "hiérarchie2_div_pourcentage.png")

#Niveau hiérarchique consultant.es
filtered_data <- data_div %>%
  filter(Emp_cons == "Oui") 
create_bar_plot(filtered_data, "Emp_statut", "hiérarchie2_cons_div.png")
create_percentage_bar_plot(filtered_data, "Emp_statut", "hiérarchie2_cons_div_pourcentage.png")

#Année du premier CDD ou CDI de la carrière
p<-ggplot(data_div, aes(x = Prem_contrat_annee)) +
  geom_bar() +
...
print(p)
ggsave(filename = "premier_emploi_div.png", plot = p, width = 8, height = 6)

#version tranches

data_div$age_group <- cut(data_div$Prem_contrat_annee, breaks = seq(0, max(data_div$Prem_contrat_annee, na.rm = TRUE), by = 5), right = FALSE)
...
print(p)
ggsave(filename = "prem_emploi_div_tranches.png", plot = p, width = 8, height = 6)




#Année du premier poste en RSE
p<- ggplot(data_div, aes(x = Prem_rse_annee_rec)) +
  geom_bar() +
...
print(p)
ggsave(filename = "premier_rse_div.png", plot = p, width = 8, height = 6)

#Temps consacré à la rse
create_bar_plot(data_div, "Rse_tps_rec", "temps_rse_div.png")

#Emp sec
create_bar_plot(data_div, "Emp_sec", "secteur_div.png")

#Temps plein
create_bar_plot(data_div, "Trav_tps", "temps_plein_div.png")

#Multinationale
create_bar_plot(data_div, "Org_multi", "multinationale_div.png")

#Salariés français
create_bar_plot(data_div, "Org_N", "salaries_fr_div.png")

#Salariés international
create_bar_plot(data_div, "Org_N_int", "salaries_int_div.png")
...
print(p)
ggsave(filename = "activ_sec_div.png", plot = p, width = 8, height = 6)

#Département RSE?
create_bar_plot(data_div, "Dep_rse", "dep_rse_div.png")
...
create_bar_plot(data_div, "Dep_rse_multi", "dep_rse_niv_div.png")

#Terme RSE
create_bar_plot(data_div, "Rse_mot", "mot_rse_div.png")

#Lois RSE
create_bar_plot(data_div, "Rse_lois", "lois_div.png")

#Vocation
create_bar_plot(data_div, "Rse_vocation_rec", "vocation_div.png")

#Critiques ONG
create_bar_plot(data_div, "Rse_ong_milit_rec", "critiques_div.png")

#Position politique 
create_bar_plot(data_div, "Pol_pos_SQ001", "politique_div.png")
